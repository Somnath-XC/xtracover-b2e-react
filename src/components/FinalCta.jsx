    ...
    <section className="bg-gradient-to-r from-cyan-500 via-blue-500 to-brand-700 py-11 text-white">
      <div className="container-site">
        <Reveal className="flex flex-col items-start justify-between gap-7 lg:flex-row lg:items-center">
          ...
          <a href="#quote" className="inline-flex min-h-[48px] shrink-0 items-center rounded-xl bg-white px-6 text-sm font-bold text-brand-700 shadow-xl transition hover:-translate-y-0.5">Request Bulk Quote</a>
        </Reveal>
      </div>
    </section>
  )
