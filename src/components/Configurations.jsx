        ...
        <div className="configuration-card-grid mt-16 grid gap-5 sm:mt-20 lg:mt-24 lg:grid-cols-3">
          {configs.map((config, index) => (
            <Reveal key={config.tier} delay={index * 75}>
              <article className={`relative h-full rounded-[26px] bg-white p-7 ${config.featured ? 'border-2 border-brand-600 shadow-2xl shadow-blue-950/10' : 'border border-slate-200 shadow-sm'}`}>
